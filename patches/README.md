...
- quota-aware OpenSky OAuth, anonymous throttling and persistent last-good data;
- replacement of GKG keyword mentions with sourced GDELT Event 2.0 records,
  stable IDs and no synthetic casualty figures.
